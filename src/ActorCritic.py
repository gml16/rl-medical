...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default="CommNet",
        choices=['CommNet', 'Network3d', 'A3C_discrete', 'A3C_continuous', 'A3C_continuous_v2', 'A3C_continuous_v3', 'A3C_continuous_v4', 'A3C_continuous_v5', 'A3C_continuous_v6'], type=str)
    parser.add_argument(
        '--stopping_criterion',
